...
from users.models import UserRegistrationModel,UserXRayModel
...
def AdminViewResults(request):
    data = UserXRayModel.objects.all()
    return render(request, 'admins/AdminViewResults.html', {'data': data})